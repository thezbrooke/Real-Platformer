...
function Wings(pos, ch){
  this.pos = this.basePos = pos;
  this.size = new Vector(0.9,0.6) //18px by12px
  //make it wibble
  this.wibble = Math.random()*Math.PI*2;
}
...
Level.prototype.animate = function(step, keys) {
  ...
  if (this.status == "won" || this.status == "lost") //not !=null bc glow will 'win'
